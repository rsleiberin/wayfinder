...
function SignUp({redirect, onClickSignIn}) {
            ...
            <div className='w-3/5 p-5'>
                ...
                <div className ='py-10'>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <div className='bg-slate-200 w-64 p-2 my-2 flex items-center mb-3'>
                            <MdLockOutline className='text-slate-500 m-2'/>
                            <input type='passwordConfirmation' name='passwordConfirmation' placeholder="Confirm Password" className='bg-slate-200 placeholder:text-slate-500 placeholder:font-semibold outline-none text-sm flex-1'/>
                        </div>
                        <div className='flex w-64 justify-between'>
                            <button onClick={onClickReturn} className='items-center font-semibold'>Cancel</button>
                            <button className='items-center text-white border-red-700 font-semibold bg-red-700 py-1 rounded-md text-lg px-12'>Sign Up</button>
                        </div>
                    </div>
                </div>
            </div>
